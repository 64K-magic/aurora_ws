...
public:
    ...
    void imuOdometryHandler(const nav_msgs::msg::Odometry::SharedPtr odomMsg)
    {
        ...
        if(lidarFrame != baselinkFrame)
        {
            ...
            tCur = tb;
            // tf2::Transform static_transform;
            // static_transform.setOrigin(tf2::Vector3(0.295, -0.00105, 0.495));
            // static_transform.setRotation(tf2::Quaternion(0, 0, 0, 1));
            
            // tf2::Stamped<tf2::Transform> tb(
            //     tCur * static_transform, 
